...
CREATE TABLE IF NOT EXISTS news_articles (
    ...
    initial_topic_title       VARCHAR(500),
    semantic_importance_score INT,
    initial_why_important     LONGTEXT,
    analysis_checkpoint       LONGTEXT,
    analysis_status           VARCHAR(20)     NOT NULL DEFAULT 'PENDING' COMMENT 'PENDING | PROCESSING | ANALYZED | TOPIC_PENDING | COMPLETED | FAILED',
    created_at       DATETIME(6)     NOT NULL,
    updated_at       DATETIME(6)     NOT NULL,
    PRIMARY KEY (id),
